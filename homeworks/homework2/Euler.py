...
T=0.01
while t<T:
    U1_star, U2_star, U3_star=Ustar_update(U1, U2, U3, F1, F2, F3, deltat)
    F1_star, F2_star, F3_star=fromU2F(U1_star, U2_star, U3_star)
    U1, U2, U3=U_update(U1, U2, U3, U1_star, U2_star, U3_star, F1_star, F2_star, F3_star, deltat)
    datos=fromU2var(U1, U2, U3)
    cs=np.sqrt(np.abs(gam*datos[1]/datos[0]))
